...
{
	if (t_check)
		render->filled_rect(100, 100, 100, 100, color(255, 255, 255));
}
		...
		auto tab_1 = new tab("A", other);
		{
			auto left = new column(tab_1);
			{
				auto group_1 = new group("group 1", { 270, 170 }, left);
				{
					...
					group_1->add(new keybind(group_1, "keybind", &t_check, &t_key_value, true));
					...
					group_1->add(new multi(group_1, "multi", { {"apple", &t_multi[0]}, {"banana", &t_multi[1]}, {"pineapple", &t_multi[2]}, {"orange", &t_multi[3]} }));
				}
				left->add(group_1);
